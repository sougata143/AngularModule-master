...
@Component({
  ...
  templateUrl: './storeEntryRegister.component.html'
})
export class storeEntryRegisterComponent implements OnInit {
	...
	constructor(public http: HttpTestService, public session: sessionServices, public router: Router) {
		var self = this;
		 ...
		 this.gridOptions.onRowClicked = function(params) {
			self.router.navigate(['security/storeentryregister',params.data.id]);
		};
	...
	searchEntry = function(){
		...
		console.log(startRangeDate, toRangeDate);
		self.http.getStoreEntryByRange(startRangeDate,toRangeDate)
			.subscribe(
			(data) => {
