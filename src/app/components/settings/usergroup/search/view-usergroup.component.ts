...
import {gridUserGrpDtlLinkComponent} from "../../../common/gridUserGroupLink.component";
...
export class userGroupComponent implements OnInit {
	...
	public columnDef : any = [
		{headerName: "User Group Id", field: "id", suppressMenu: true,  minWidth : 350},//cellRendererFramework: gridUserGrpDtlLinkComponent,
		{headerName: "User Group Name", field: "userGroupName", suppressMenu: true, minWidth : 250},
		{headerName: "Status", field: "isEnable", suppressMenu: true, cellRendererFramework: gridUserStatus, minWidth : 100, maxWidth:150, width:140},
		{headerName: "Created On", field: "fromDate", suppressMenu: true, minWidth : 350}
	];
	...
	constructor(public http: HttpTestService, public router: Router, public session: sessionServices) {
		...
		this.gridOptions.onRowClicked = function(params) {
			 self.router.navigate(['settings/usergroup',params.data.id]);
		 };
