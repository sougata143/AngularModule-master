...
import {gridPOSupApprovalLinkComponent} from "../../common/gridPOSupApprovalLink.Component";

@Component({
  selector: 'app-worklist',
  templateUrl: './supplierApprovalWorklist.component.html'
})
export class supplierApprovalWorklistComponent implements OnInit {
	...
	public columnDef : any = [
		{headerName: "INDENT NUMBER", field: "id", suppressMenu: true, cellRendererFramework: gridPOSupApprovalLinkComponent, minWidth : 350},
	...
	constructor(public http: HttpTestService, public router: Router, public session: sessionServices) { 
		...
		this.gridOptions.onRowClicked = function(params) {
			 self.router.navigate(['purchase/supplierapprovallist',params.data.id]);
		 };
	}
	...
	loadApprovalRequest = function() {
		...
		this.http.getIndenApprovalList(22)
			.subscribe(
			(data) => {
