...
import {gridPOPriceLinkComponent} from "../../common/gridPOPriceLink.Component";


@Component({
  selector: 'app-create-indent',
  templateUrl: './inviteVendorComponent.component.html'
})
...
export class inviteVendorComponent implements OnInit {
	...
	public columnDef : any = [
		{headerName: "INDENT NUMBER", field: "id", suppressMenu: true, cellRendererFramework: gridPOPriceLinkComponent, minWidth : 350},
	...
	constructor(public http: HttpTestService, public router: Router, public session: sessionServices) {
		...
		this.gridOptions.onRowClicked = function(params) {
			 self.router.navigate(['purchase/requestprice',params.data.id]);
		 };
	}
	...
	loadApprovalRequest = function() {
		...
		this.http.getIndenApprovalList(3)
			.subscribe(
			(data) => {
