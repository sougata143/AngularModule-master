...
@Component({
  ...
  templateUrl: './jutequalitypriceList.component.html'
})
export class jutequalitypriceListComponent implements OnInit {
	...
	public columnDef : any = [
		...
		{headerName: "JUTE TYPE", field: "itemCode", minWidth : 250},
