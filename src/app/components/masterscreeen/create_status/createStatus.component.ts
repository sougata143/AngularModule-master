...
createStatus = function(){
			...
			this.http.createStatus(self.statusCreateModel)
				...
				() => {
					...
					self.statusCreateModel.id="";
					self.statusCreateModel.statusName="";
					self.loadstatusList();
...
updateDeviation = function(index){
			...
			self.statusList[index].deviation = (self.statusList[index].statusName - self.statusList[index].statusName);
