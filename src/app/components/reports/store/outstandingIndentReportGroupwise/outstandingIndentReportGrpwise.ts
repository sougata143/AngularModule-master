...
@Component({
  ...
  templateUrl: './outstandingIndentReportGrpwise.html'
})
export class outstandingIndentReportGrpwiseComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.getOutstandingReportDeptise(self.reportModel.reportdate.formatted)
			.subscribe(
			(data) => {
