...
@Component({
  ...
  templateUrl: './indentdetailitemwise.html'
})
export class indentdetailsitemwiseReportComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.getIndentDetailsReportItemwise(self.reportModel.reportdate.formatted, self.reportModel.reportTodate.formatted)
			.subscribe(
			(data) => {
