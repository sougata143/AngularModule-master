...
@Component({
  ...
  templateUrl: './indentcancelregister.html'
})
export class indentcancelregisterComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.getIndentCancelRegisterReport(self.reportModel.reportdate.formatted, self.reportModel.reportTodate.formatted)
			.subscribe(
			(data) => {
