...
@Component({
  ...
  templateUrl: './outstandingIndentReportItemwise.html'
})
export class outstandingIndentReportItemwiseComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.getOutstandingReportItemwise(self.reportModel.reportdate.formatted)
			.subscribe(
			(data) => {
