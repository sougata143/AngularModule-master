...
@Component({
  ...
  templateUrl: './outstandingIndentReportDeptwise.html'
})
export class outstandingIndentReportDeptwiseComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.getWaitingForPOReport(self.reportModel.reportdate.formatted)
			.subscribe(
			(data) => {
