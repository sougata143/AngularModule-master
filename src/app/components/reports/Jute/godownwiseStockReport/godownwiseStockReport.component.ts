...
@Component({
  ...
  templateUrl: './godownwiseStockReport.component.html'
})
export class godownwiseStockReportComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.godownwisestockregisterreport(self.reportModel.reportdate.formatted)
			.subscribe(
			(data) => {
