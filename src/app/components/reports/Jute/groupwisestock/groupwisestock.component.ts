...
@Component({
  ...
  templateUrl: './groupwisestock.component.html'
})
export class groupwisestockComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.GroupwiseQualityStockRegister(self.reportModel.reportdate.formatted)
			.subscribe(
			(data) => {
