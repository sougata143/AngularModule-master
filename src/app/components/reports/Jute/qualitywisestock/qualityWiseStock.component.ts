...
@Component({
  ...
  templateUrl: './qualityWiseStock.component.html'
})
export class qualityWiseStockComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.getqualitywisestockreport(self.reportModel.reportdate.formatted)
			.subscribe(
			(data) => {
