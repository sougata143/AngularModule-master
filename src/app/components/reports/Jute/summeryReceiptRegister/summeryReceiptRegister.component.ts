...
@Component({
  ...
  templateUrl: './summeryReceiptRegister.component.html'
})
export class summeryReceiptRegisterComponent implements OnInit {
	...
	searchReport = function(){
		var self = this;
		self.reportdata = "";
		self.http.summeryreport(self.reportModel.reportdate.formatted)
			.subscribe(
			(data) => {
