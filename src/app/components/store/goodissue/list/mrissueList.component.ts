...
import {gridMrIssueSearchLinkComponent} from "../../../common/mrIssueSearchLink";
import {gridtatusComponent} from "../../../common/gridDtatus.component";


@Component({
  selector: 'app-mr-list',
  templateUrl: './mrissueList.component.html'
})


export class mrissueListComponent implements OnInit {
	...
	public columnDef : any = [
		{headerName: "Issue Id", field: "issueHeader.id", suppressMenu: true, cellRendererFramework: gridMrIssueSearchLinkComponent, minWidth : 350},
	...
	constructor(public http: HttpTestService, public session: sessionServices, public router: Router) { 
		var self = this;
		 ...
		 this.gridOptions.onRowClicked = function(params) {
			 self.router.navigate(['jute/mrgoodissue',params.data.issueHeader.id]);
		 };
	}
			...
			.subscribe(
				...
				() => {
					for(var i = 0; i < self.allOpenMrList.length; i++){
						if(self.allOpenMrList[i].issueHeader.goodType == "MR"){
